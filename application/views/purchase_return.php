                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">                                 
                                 <label for="invoice_no" class="col-sm-2 control-label"><?= $this->lang->line('invoice_no'); ?> </label>
                                 <div class="col-sm-3">
                                    <input type="text" value="<?php echo  $invoice_no_no; ?>" class="form-control " id="invoice_no" name="invoice_no" placeholder="" >
                                    <span id="invoice_no_msg" style="display:none" class="text-danger"></span>
                                 </div>                                 
                              </div>
                              <!-- <div class="form-group">
