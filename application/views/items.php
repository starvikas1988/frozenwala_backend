                        ...
                        <div class="box-body">
                          ...
                          <!-- <div class="row">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 <label for="profit_margin"><?= $this->lang->line('profit_margin'); ?>(%) <i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-content="<?= $this->lang->line('based_on_price'); ?>" data-html="true" data-trigger="hover" data-original-title="">
                           ...
                           <div class="row">
                              ...
                              <!-- ✅ Add Piece Count Input -->
                              <div class="form-group col-md-4">
                                 <label for="piece_count"><?= $this->lang->line('piece_count') ? $this->lang->line('piece_count') : 'Piece Count'; ?></label>
                                 <input type="text" class="form-control only_currency" id="piece_count" name="piece_count" value="<?= isset($piece_count) ? $piece_count : ''; ?>">
                                 <span id="piece_count_msg" style="display:none" class="text-danger"></span>
                              </div>
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="variant_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:10%"><?= $this->lang->line('piece_count'); ?></th>
