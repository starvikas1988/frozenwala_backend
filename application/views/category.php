               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="box box-primary ">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="category-form" enctype="multipart/form-data" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                              <label for="category_image" class="col-sm-2 control-label"><?= $this->lang->line('image'); ?></label>
                              <div class="col-sm-4">
                                 ...
                                 <?php if (!empty($image)) { ?>
                                    <div style="margin-top: 10px;">
                                       <img src="<?= base_url('uploads/category/' . $image); ?>" alt="Category Image" style="max-height: 100px;">
                                    </div>
