...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="btn-group hidden-xs">
            ...
            <ul class="dropdown-menu" >
                  ...
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>sales/chalan" ><h4><i class="fa fa-plus text-green"></i> <?= $this->lang->line('Chalan'); ?></h4></a>
                  </li>
                  <?php } ?>
  ...
  <aside class="main-sidebar">
    ...
    <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li chalan-active-li chalan-list-active-li sales-payments-list-active-li treeview">
          <a href="#">
        ...
        <li class="chalan-active-li"><a href="<?php echo $base_url; ?>sales/chalan"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_chalan'); ?></span></a></li>
        <?php } ?>
        ...
        <li class="cloudsales-active-li"><a href="<?php echo $base_url; ?>cloudsales"><i class="fa fa-list "></i> <span>Online Sales List</span></a></li>
        
        
        <?php } ?>
        
		 <?php if($CI->permissions('sales_view')) { ?>
        <li class="chalan-list-active-li"><a href="<?php echo $base_url; ?>sales/chalan_list"><i class="fa fa-list "></i> <span><?= $this->lang->line('chalan_list'); ?></span></a></li>
        <?php } ?>
...
<small class="label bg-green">new</small>
    ...
    <li class="pos-active-li stock_adjustment_list-active-li stock_adjustment-active-li stock_adjustment-return-active-li stock_adjustment-return-list-active-li stock_transfer-active-li stock_transfer_list-active-li treeview">
          ...
          <ul class="treeview-menu">
          <li class="stock_adjustment_list-active-li stock_adjustment-active-li"><a href="<?php echo $base_url; ?>stock/index"><i class="fa fa-cubes "></i> <span>Manage Stock</span></a></li>
    ...
    <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li  reports-menu treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/ledger" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('ledger_report'); ?></span>
              </a></li>
            <?php } ?>
            ...
            <li class="report-stock-li"><a href="<?php echo $base_url; ?>reports/stock_aging" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('stock_report_aging'); ?></span>
              </a></li>
            <?php } ?>
    ...
    <li class=" site-settings-active-li  change-pass-active-li dbbackup-active-li  tax-active-li currency-view-active-li  store_profile-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li gateways-active-li package-active-li subscription-active-li  subscription-list-active-li  package-list-active-li sms-api-active-li smtp-active-li treeview">
          ...
          <!--  <?php if($CI->permissions('sms_api_view')) { ?>
            ...
            <?php if(!is_user()){?>
                ...
                <?php } ?>
                <?php if($CI->permissions('units_view')) { ?>
                <li class="units-list-li unit-li"><a href="<?php echo $base_url; ?>finance/"><i class="fa fa-list "></i> <span><?= $this->lang->line('finance_list'); ?></span></a></li>
                <?php } ?>
