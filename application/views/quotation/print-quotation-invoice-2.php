              ...
              <tr>
                ...
                <td colspan="4">
                 <b><?php echo $store_name;?></b><br>
                    ...
                    GST: <?php echo $company_gst_no;?>
                    <br>
                    <br>
                  
                    Phone - <?php echo $company_mobile; if($company_phone!='') { ?> / <?php echo $company_phone; }?>
                </td>
...
<tbody>
 ...
 <?php
              ...
              $this->db->select(" c.description,c.item_name, a.quotation_qty,a.serial_no,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost , d.unit_name,c.hsn
                              ");
...
<tfoot>
 ...
 -->
                         <tr>
                          ...
                          <td colspan='8'>
                            <span><b> <?= $this->lang->line('authorised_signatory'); ?></b><br></span>
                            <img src="<?= base_url();?>uploads/sig.jpeg" width="150" height="60">
                          </td>
                        </tr>
