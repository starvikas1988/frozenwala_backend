      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
           ...
           <!--        <b>Branch off:</b><br> FARTABAD, NEAR KATHER BARI, GARIA, KOLKATA- 700084<br>-->
           <!--         GST: 19AGLPG6090R1ZI-->
           <!--         <br>-->
           <!--         <br>-->
           <!--         <b>Corporate Off:</b><br>-->
           <!--         14, GANESH CHANDRA AVENUE,<br>-->
           <!--         K G N HOUSE, 3RD FLOOR,<br>-->
           <!--         KOLKATA - 700013.<br>-->
           <!--         Phone - 9830440665 / 9062493176-->
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              $q2=$this->db->query("SELECT c.description,c.item_name, a.quotation_qty,a.tax_type,a.serial_no,
