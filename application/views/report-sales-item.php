   ...
   <body class="hold-transition skin-blue sidebar-mini">
      ...
      <script type="text/javascript">
         ...
         function load_items_list(){
              ...
              $.post(base_url+"sales/get_items_select_list",{category_id:category_id,store_id:store_id,item_type:$("#item_type").val()},function(result){
               console.log(result);
                  result='<option value="">All</option>'+result;
