     ...
     <section class="content">
               ...
               <!-- ********** ALERT MESSAGE END******* -->
                  ...
                  <span id="reference_no_msg" style="display:none" class="text-danger"></span>
                                 ...
                                 <label for="reference_no" class="col-sm-2 control-label"><?= $this->lang->line('return_code'); ?> </label>
                                 <div class="col-sm-2">
                                    <input type="text" value="<?php echo  $return_code; ?>" class="form-control " id="return_code" name="return_code" placeholder="" >
                  <!-- <span id="reference_no_msg" style="display:none" class="text-danger"></span> -->
                                 </div>
