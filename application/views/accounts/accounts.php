                           ...
                           <div class="box-body">
                              <div class="row">
                                 <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                       <label for="bank_name" class="col-sm-4 control-label"><?= $this->lang->line('bank_name'); ?> <label class="text-danger">*</label></label>
                                       <div class="col-sm-8">
                                          <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder=""  value="<?php print $bank_name; ?>" >
                                          <span id="bank_name_msg" style="display:none" class="text-danger"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="ifsc_code" class="col-sm-4 control-label"><?= $this->lang->line('ifsc_code'); ?> <label class="text-danger">*</label></label>
                                       <div class="col-sm-8">
                                          <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder=""  value="<?php print $ifsc_code; ?>" >
                                          <span id="ifsc_code_msg" style="display:none" class="text-danger"></span>
                                       </div>
                                    </div>
                                    <!-- ########### -->
                                 </div>
