...
<div class="modal fade " id="item-modal" tabindex='-1'>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <span id="m_brand_msg" class="text-danger text-right pull-right">
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i></button>
                                    </span>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <span id="m_category_id_msg" class="text-danger text-right pull-right">
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#exampleModalCategory"><i class="fa fa-plus"></i></button>
                                    </span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url();?>sales/new_brand" method="post" enctype="multipart/form-data">
      <div class="modal-body">
         <div class="row">
    <div class="col-md-6">
...
<div class="modal fade" id="exampleModalCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url();?>sales/new_category" method="post" enctype="multipart/form-data">
      <div class="modal-body">
        <div class="row">
    <div class="col-md-6">
    <input type="text" placeholder="Enter Category" name="category_name" class="form-control">
    </div>
    <div class="col-md-6">
       <textarea name="description" placeholder="Enter Description" class="form-control"></textarea>
    </div>
