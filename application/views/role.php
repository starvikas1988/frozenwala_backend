                              ...
                              <div class="form-group">
                                 <div class="col-sm-12">
                                    ...
                                    <!--    <?php if(store_module()){ ?>
                                        ...
                                        <!-- <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('help_documentation_link'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="help"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          ...
                                          <td>
                                              <input type="hidden" name="module[help]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="help_all" id='help_link' name="permission[help_link]"> <?= $this->lang->line('show_link'); ?> (<?= $this->lang->line('show_link_message'); ?>)
                                              </label></div>
                                          </td>
