                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                    <div class="input-group">
                                       <select class="form-control select2" id="supplier_id" name="supplier_id"  style="width: 100%;" >
                                          <?= get_suppliers_select_list($supplier_id,get_current_store_id(),$show_select=true); ?>
                                       </select>
                                 ...
                                 <label class="col-sm-2 control-label"><?= $this->lang->line('purchase_date'); ?> <label class="text-danger">*</label></label>
                                 <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                  <label for="reference_no" class="col-sm-2 control-label"><?= $this->lang->line('purchase_invoice_no'); ?> </label>
                                 <div class="col-sm-3">
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <?php /*
                                                   <th rowspan='2' style="width:15%"><?= $this->lang->line('serial_no'); ?></th>
                                                   */ ?>
                                                   <th rowspan='2' style="width:15%;min-width: 180px;"><?= $this->lang->line('quantity'); ?></th>
                                                   <th rowspan='2' style="width:10%"><?= $this->lang->line('unit'); ?></th>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="hidden" name="cgst_percent" id="cgst_percent_input">
                                          <input type="hidden" name="sgst_percent" id="sgst_percent_input">
                                          <input type="hidden" name="cgst_amount" id="cgst_amount_input">
                                          <input type="hidden" name="sgst_amount" id="sgst_amount_input">
                                             ...
                                             <tr>
                                             <tr>
                                                <td class="text-right" style="font-size: 17px;" id="cgst_display_per" >CGST</td>
                                                <td class="text-right"  style="padding-left:10%;font-size: 17px;" id="cgst_display">
                                                   <h4>₹0.00</h4>
                                                   
                                                </td>
                                                </tr>
                                                <tr>
                                                <td class="text-right" style="font-size: 17px;" id="sgst_display_per" >SGST</td>
                                                <td class="text-right"  style="padding-left:10%;font-size: 17px;" id="sgst_display">
                                                <h4>₹0.00</h4>
                                                </td>
                                             </tr>
         ...
         function final_total(){
          ...
          //Show total Purchase Quantitys
           ...
           if((subtotal!=null || subtotal!='') && (subtotal!=0)){
            ...
            let totalGST = parseFloat(other_charges_tax_id);

            // Fallback to 0 if totalGST is invalid
            ...
            let cgstAmt = (cgst * subtotal) / 100;
            let sgstAmt = (sgst * subtotal) / 100;
          

            // Display
            document.getElementById('cgst_display_per').innerText = `CGST (${cgst}%)`;
            document.getElementById('sgst_display_per').innerText = `SGST (${sgst}%)`;
            document.getElementById('cgst_display').innerText = ` ₹${cgstAmt.toFixed(2)}`;
            document.getElementById('sgst_display').innerText = ` ₹${sgstAmt.toFixed(2)}`;

            document.getElementById('cgst_percent_input').value = cgst;
            document.getElementById('sgst_percent_input').value = sgst;
            document.getElementById('cgst_amount_input').value = cgstAmt.toFixed(2);
            document.getElementById('sgst_amount_input').value = sgstAmt.toFixed(2);
