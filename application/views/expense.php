      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary ">
            ...
            <form class="form-horizontal" id="expense-form" >
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  <!-- Store Code -->
                    <?php /*if(store_module() && is_admin()) {$this->load->view('store/store_code',array('show_store_select_box'=>true,'store_id'=>$store_id,'label_length'=>'col-md-4','div_length'=>'col-sm-8')); }else{*/
          ...
          <span id="expense_for_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="payment_type" class="col-sm-4 control-label"><?= $this->lang->line('payment_type'); ?> <label class="text-danger">*</label></label>
                        ...
                        <?php
                          $q1=$this->db->query("select * from db_paymenttypes where status=1 and store_id=".get_current_store_id());
                           if($q1->num_rows()>0){
                              echo "<option value=''>-Select-</option>";
                               foreach($q1->result() as $res1){
                                $selected = (!empty($payment_type) && $payment_type==$res1->payment_type)? 'selected' : '';
