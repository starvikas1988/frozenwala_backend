        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              $tot_total_cost=0;
              $q2=$this->db->query("SELECT c.description,c.item_name, a.purchase_qty,a.tax_type,d.unit_name,a.serial_no,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost 
                                  FROM 
                                  db_purchaseitems AS a,db_tax AS b,db_items AS c,db_units AS d 
                                  WHERE 
                                  c.id=a.item_id AND b.id=a.tax_id AND a.purchase_id='$purchase_id' AND c.unit_id=d.id");
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td>".format_qty($res2->price_per_unit*$res2->purchase_qty)."</td>";
                  ...
                  $tot_tax_value =$tot_purchase_price*$res2->purchase_qty;
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td><?= $CI->currency($tot_purchase_price);?></td>
                <td class="text-left"><?=format_qty($tot_qty);?></td>
                 <td class="text-left"><?=format_qty($tot_tax_value);?></td>
              ...
              <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <table  class="col-md-11">
                       ...
                       <tr>
                       <th class="text-right" style="font-size: 17px;">CGST <?=number_format($cgst_per, 2); ?>%</th>

                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h4><b id="cgst_amt" name="cgst_amt"><?=$CI->currency($cgst_amt);?></b></h4>
                          </th>
                       </tr>
                       <tr>
                          <th class="text-right" style="font-size: 17px;">SGST <?=number_format($sgst_per, 2); ?>%</th>
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h4><b id="sgst_amt" name="sgst_amt"><?=$CI->currency($sgst_amt);?></b></h4>
                          </th>
                       </tr>
                       <tr>
