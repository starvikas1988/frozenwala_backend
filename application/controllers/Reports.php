...
class Reports extends MY_Controller {
	...
	public function ledger(){
		$this->permission_check('sales_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('ledger_report');
		$this->load->view('report-ledger', $data);
	}
	public function show_ledger_report(){
		echo $this->reports->show_ledger_report();
	}
	...
	public function stock_aging(){
		$this->permission_check('stock_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('stock_report_aging');
		$this->load->view('report-stock-aging', $data);
	}
	
	public function get_stock_aging_report(){
		$data = array(
			'item_wise_report' => $this->show_stock_aging_report(),
			'brand_wise_stock' => $this->brand_wise_stock(),
			//'category_wise_stock' => $this->category_wise_stock(),
		);
		//print_r($data);exit;
	...
	public function show_stock_aging_report(){
		return $this->reports->show_stock_aging_report();
	}
