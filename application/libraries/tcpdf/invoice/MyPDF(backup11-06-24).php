...
class MyPDF extends TCPDF {
    ...
    public function _get_company_details()
    {
        $store = $this->store;
        $txt='';
        $txt .= '<span style="font-size:16px;font-weight:500;">JEE ELECTRONICS</span>';
        //$txt .= '<br><span style="font-size:12px;"><b>Branch off:</b></span>';
        $txt .= '<br><span style="font-size:12px;">Jogibattala, Khasmallick, Garia Main Road, Kolkata- 700145</span>';
        $txt .= '<br><span style="font-size:12px;">GST: 19AITPH3460L1ZO</span>';
        $txt .= '<br><span style="font-size:12px;">Mobile: 8293487112</span>';
        ...
        $this->writeHTMLCell($w =70, 0, $x='38', $y='16', $txt, $border = 0, 0, 0, true, '', true);
        return $this;
    }
