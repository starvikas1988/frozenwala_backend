		...
		<table >';
		    ...
		    $tbl .='<thead>
		        <tr class="bg-light-blue text-bold">
			        ...
			        <th colspan="1" style="width: '.$colW['before_tax'].'">'.$this->CI->lang->line("rate").'</th>
              ...
              $q2=$this->CI->db->get();
		        ...
		        foreach ($q2->result() as $res2) {
                 ...
                 $tbl .='<tr style="" nobr="true">';
				      ...
				      $tbl .='<td colspan="1" class="text-right" style="width: '.$colW['before_tax'].'">'.store_number_format($before_tax).'</td>';
				          
					
					  
				      $tbl .='<td colspan="1" class="text-right" style="width: '.$colW['discount'].'">'.($discount).'</td>';
				      $tbl .='<td colspan="1" class="text-right" style="width: '.$colW['amount'].'">'.store_number_format($tot_cost_before_tax).'</td>';
		          $tbl .='</tr>';
		...
		$tbl .='<table>
		            <tbody>';
		            	...
		            	$tbl .='<tr nobr="true" class="text-bold">';
			                ...
			                $tbl .=store_number_format($tot_before_tax);
			                $tbl .='</td>';
