...
class MyPDF extends TCPDF {
    ...
    public function _get_company_details()
    {
        ...
        $txt='';
        $txt .= '<span style="font-size:16px;font-weight:bold; text-align:center;">'.$store->store_name.'</span>';
        //$txt .= '<br><span style="font-size:12px;"><b>Branch off:</b></span>';
        $txt .= '<br><span style="font-size:12px; text-align:center;">'.$store->address.'</span>';
        $txt .= '<br><span style="font-size:12px; font-weight:bold; text-align:center;">GST: '.$store->gst_no.'</span>';
        $txt .= '<br><span style="font-size:12px; text-align:center;">Mobile: '.$store->mobile.'</span>';
        $txt .= '<br><span style="font-size:12px; text-align:center;">Email: '.$store->email.'</span>';
        ...
        $this->writeHTMLCell($w =70, 0, $x='72', $y='16', $txt, $border = 0, 0, 0, true, '', true);
        return $this;
    }
     ...
     public function _get_address_details()
    {
        $store = $this->store;
        $txt='';
        
        // $txt .= '<span style="font-size:12px;"><b>Corporate Off:</b></span>';
        // $txt .= '<br><span style="font-size:12px;">BARUIPUR KHASMOLLICK,</span>';
        // $txt .= '<br><span style="font-size:12px;">KOLKATA - 700145.</span>';
        // $txt .= '<br><span style="font-size:12px;">Phone - 9999999999</span><br>';
        ...
        $this->writeHTMLCell($w =70, 0, $x='108', $y='16', $txt, $border = 0, 0, 0, true, '', true);
        return $this;
    }
