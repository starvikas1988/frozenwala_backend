...
class Accounts_model extends CI_Model {
	...
	public function verify_and_save(){
		...
		$query1=$this->db->query("select * from ac_accounts where upper(ifsc_code)=upper('$ifsc_code') and store_id=$store_id");
		if($query1->num_rows()>0){
			return "Sorry! This IFSC Code already Exist.";
		}
	...
	public function get_details($id,$data){
		...
		if($query->num_rows()==0){
			...
			$data['ifsc_code']=$query->ifsc_code;
	...
	public function update_accounts(){
		...
		$query1=$this->db->query("select * from ac_accounts where upper(ifsc_code)=upper('$ifsc_code') and id!=$q_id and store_id=$store_id");
		if($query1->num_rows()>0){
			return "Sorry! This IFSC Code already Exist.";
		}
		$this->db->where("upper(account_name)",strtoupper($account_name));
